...
public class TaskLineApi {
  ...
  /* Build call for post */
  private Call postCall(TaskLineWriterServiceModel taskLineWriterServiceModel, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    Object localVarPostBody = taskLineWriterServiceModel;
    
    // verify the required parameter 'taskLineWriterServiceModel' is set
    if (taskLineWriterServiceModel == null) {
       throw new ApiException("Missing the required parameter 'taskLineWriterServiceModel' when calling post(Async)");
    }
    

    // create path and map variables
    String localVarPath = "/TaskLine".replaceAll("\\{format\\}","json");
   ...
   * 
   * Post taskline
   * @param taskLineWriterServiceModel Taskline description (required)
   * @return TaskLineReaderServiceModel
   * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
   */
  public TaskLineReaderServiceModel post(TaskLineWriterServiceModel taskLineWriterServiceModel) throws ApiException {
    ApiResponse<TaskLineReaderServiceModel> resp = postWithHttpInfo(taskLineWriterServiceModel);
    return resp.getData();
  }
   ...
   * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
   */
  public ApiResponse<TaskLineReaderServiceModel> postWithHttpInfo(TaskLineWriterServiceModel taskLineWriterServiceModel) throws ApiException {
    Call call = postCall(taskLineWriterServiceModel, null, null);
    Type localVarReturnType = new TypeToken<TaskLineReaderServiceModel>(){}.getType();
    return apiClient.execute(call, localVarReturnType);
  }
   ...
   * @throws ApiException If fail to process the API call, e.g. serializing the request body object
   */
  public Call postAsync(TaskLineWriterServiceModel taskLineWriterServiceModel, final ApiCallback<TaskLineReaderServiceModel> callback) throws ApiException {
    ...
    Call call = postCall(taskLineWriterServiceModel, progressListener, progressRequestListener);
    Type localVarReturnType = new TypeToken<TaskLineReaderServiceModel>(){}.getType();
    apiClient.executeAsync(call, localVarReturnType, callback);
    return call;
  }
